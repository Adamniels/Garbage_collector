...
/// @param index the position in the list
/// @param result a pointer to store the value of the removed node
/// @return a bool of we if was a valid remove
...
/// @param list the linked list that will be extended
/// @param index the position in the list
/// @param result a pointer to store the value for the node we wanted
/// @return if it was a valid get or not
